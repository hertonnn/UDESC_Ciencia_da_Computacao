...
public class OrcamentoTableModel extends AbstractTableModel {
    ...
    public Object getValueAt(int linhaIndex, int colunaIndex) {
        ...
        switch (colunaIndex) {
            ...
            case 5:
                ...
                retorno = NumberFormat.getCurrencyInstance(new Locale("pt", "BR")).format(valor);
                return retorno;       
            default:
    ...
    public void calcula_total() {
        this.total_despesa = 0;
        this.total_receira = 0;
    ...
    public Orcamento getOrcamento(int index){
