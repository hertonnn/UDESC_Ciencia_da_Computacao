...
public class GraficoDial {
    ...
    private JFreeChart createChart(ValueDataset valorGasto, ValueDataset valorOrcamento) {
        ...
        Font quickSand = null;
        try{
        quickSand = Font.createFont(Font.TRUETYPE_FONT, new File("src/recursos/fontes/quicksand/Quicksand_Bold.otf"));
        }
        ...
        meterplot.setTickLabelFormat(NumberFormat.getCurrencyInstance(localBrasil));
        meterplot.setValueFont(quickSand);
